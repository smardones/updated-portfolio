    ...
    return(
        <section className="page-body">
            ...
            <div className="about-wrapper">
                ...
                <p>With a decade in finance and customer service under my belt, I bring a unique perspective that delivers flexibility, quick-thinking, and the ability to quickly pick up new concepts.</p>
